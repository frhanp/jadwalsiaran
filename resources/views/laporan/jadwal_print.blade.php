...
<head>
    ...
    <style>
        ...
        .schedule-table th, .schedule-table td { border: 1px solid #333; padding: 6px; text-align: left; vertical-align: top; }
        .schedule-table th { background-color: #f2f2f2; }
        .signature-section { margin-top: 40px; }
        .signature-block { margin-bottom: 40px; page-break-inside: avoid; }
        .signature-grid { display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 20px; text-align: center; margin-top: 30px; }
        .signature-grid div { padding-top: 60px; }
                ...
                <div class="signature-block">
                    ...
                    <div class="signature-grid">
                        <div>
                            ...
                            <span class="font-semibold underline">({{ $petugas->penyiarDinas->name ?? '____________________' }})</span>
                        </div>
                        <div>
                            Pengelola Pro 2<br><br><br><br>
                            <span class="font-semibold underline">({{ $petugas->pengelolaPep->name ?? '____________________' }})</span>
                        </div>
                        <div>
                            Petugas LPU<br><br><br><br>
                            <span class="font-semibold underline">({{ $petugas->petugasLpu->name ?? '____________________' }})</span>
                        </div>
                    </div>
                </div>
                @endif
