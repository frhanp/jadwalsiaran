                    ...
                    <div class="mb-6 bg-gray-50 p-4 rounded-lg border border-gray-200">
                        <form method="GET" action="{{ route('admin.users.index') }}" class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 items-end">
                            ...
                            <div>
                                ...
                                <select name="role" id="role" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm text-sm">
                            ...
                            <div>
                                ...
                                <select name="studio_id" id="studio_id" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm text-sm">
                        ...
                        <table class="min-w-full text-sm border border-gray-200 rounded-lg overflow-hidden">
                            ...
                            <tbody class="divide-y divide-gray-200">
                                ...
                                <tr class="hover:bg-gray-50 transition-colors">
                                    <td class="px-4 py-3">{{ $loop->iteration + $users->firstItem() - 1 }}</td> {{-- Perbaiki nomor --}}
                                    ...
                                    <td class="px-4 py-3 text-gray-600">{{ $user->studio->nama ?? '--' }}</td> {{-- Tampilkan Nama Studio --}}
                                    <td class="px-4 py-3">
                                        <div class="flex flex-wrap gap-2">
                                            ...
                                            <form x-data @submit.prevent=" /* ... SweetAlert ... */ "
                                ...
                                @empty
                                <tr>
                                    <td colspan="6" class="text-center py-6 text-gray-500"> {{-- Ubah colspan --}}
